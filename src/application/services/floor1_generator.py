...
class Floor1Generator:
    ...
    def generate(self) -> Floor1Data:
        ...
        # Generate main path (vertical corridor, adjusted width)
        entrance, stair_down, main_path = self._generate_main_path(dungeon_map, adjusted_main_path_width)

        # Generate side rooms branching from main path
        side_rooms = self._generate_side_rooms(dungeon_map, main_path, adjusted_den_count)
    ...
    def _generate_main_path(self, dungeon_map: np.ndarray, path_width: int = 3) -> Tuple[Tuple[int, int], Tuple[int, int], List[Tuple[int, int]]]:
    ...
    def _generate_side_rooms(self, dungeon_map: np.ndarray, main_path: List[Tuple[int, int]], room_count: int = 4) -> List[Dict]:
        """Generate side rooms branching from main path."""
        side_rooms = []
